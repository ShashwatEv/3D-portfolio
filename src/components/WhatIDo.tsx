        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build end-to-end web applications, real-time communication
                systems, APIs, and cross-platform desktop experiences.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>INTELLIGENCE</h3>
              <h4>Applied AI &amp; security</h4>
              <p>
                I work with predictive analytics, sentiment scoring, and
                blockchain verification to make software more useful and
                resilient.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
